...
@section('content')
    <main class="content">
        <div class="container p-0">
            <h1 class="mb-3 fw-bold my-text-color">Edit Desa</h1>
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('desa.update', [$nama_desa_calon->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_desa_calon') is-invalid @enderror"
                                    id="nama_desa_calon" value="{{ old('nama_desa_calon', $nama_desa_calon->nama_desa_calon) }}"
                                    name="nama_desa_calon">
